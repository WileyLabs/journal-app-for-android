...
*/        Class<? extends ActionBarSherlock> impl = impls.values().iterator().next();
    ...
    protected final boolean callbackCreateOptionsMenu(Menu menu) {
        ...
        boolean result = true;
        if (mListener instanceof OnCreatePanelMenuListener) {
            OnCreatePanelMenuListener listener = (OnCreatePanelMenuListener)mListener;
            result = listener.onCreatePanelMenu(Window.FEATURE_OPTIONS_PANEL, menu);
        } else if (mListener instanceof OnCreateOptionsMenuListener) {
            OnCreateOptionsMenuListener listener = (OnCreateOptionsMenuListener)mListener;
    ...
    protected final boolean callbackPrepareOptionsMenu(Menu menu) {
        ...
        boolean result = true;
        if (mListener instanceof OnPreparePanelListener) {
            OnPreparePanelListener listener = (OnPreparePanelListener)mListener;
            result = listener.onPreparePanel(Window.FEATURE_OPTIONS_PANEL, null, menu);
        } else if (mListener instanceof OnPrepareOptionsMenuListener) {
            OnPrepareOptionsMenuListener listener = (OnPrepareOptionsMenuListener)mListener;
    ...
    protected final boolean callbackOptionsItemSelected(MenuItem item) {
        ...
        if (mListener instanceof OnMenuItemSelectedListener) {
            OnMenuItemSelectedListener listener = (OnMenuItemSelectedListener)mListener;
            result = listener.onMenuItemSelected(Window.FEATURE_OPTIONS_PANEL, item);
        } else if (mListener instanceof OnOptionsItemSelectedListener) {
            OnOptionsItemSelectedListener listener = (OnOptionsItemSelectedListener)mListener;
