...
public class ActionBarImpl extends ActionBar {
    ...
    public ActionBarImpl(Activity activity, int features, ViewGroup viewGroup) {
        mActivity = activity;
/* todo: ???
...
// todo: ???            mContentView = (NineFrameLayout)decor.findViewById(android.R.id.content);
        }
    }
...
// todo ???:        mContextDisplayMode = mActionView.isSplitActionBar() ? CONTEXT_DISPLAY_SPLIT : CONTEXT_DISPLAY_NORMAL;
        mContextDisplayMode = CONTEXT_DISPLAY_SPLIT;

        // Older apps get the home button interaction enabled by default.
        // Newer apps need to enable it explicitly.
// todo ???:        boolean homeButtonEnabled = mContext.getApplicationInfo().targetSdkVersion < Build.VERSION_CODES.ICE_CREAM_SANDWICH;
...
//        }
    ...
    @Override
    public void setActionModeBackground(Drawable drawable) {
        mActionMode.setBackgroundDrawable(drawable);
    }
    /**
     * @hide
     */
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void setBackgroundDrawable(Drawable d) {
            mContextView.setBackgroundDrawable(d);
        }
