...
public class ActionBarSherlockCompat extends ActionBarSherlock implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, android.view.MenuItem.OnMenuItemClickListener {
    ...
    public ActionBarSherlockCompat(Activity activity, int flags, ViewGroup viewGroup) {
        super(activity, flags);
        mViewGroupParent = viewGroup;
    }
...
//    private ActionBarSherlock mSherlock;
    ...
    public ActionBarSherlockCompat setupActionBar() {
        ...
        this.actionBarCustomView = new FrameLayout(mActivity);
...
//        contextView.setBackgroundDrawable(new ColorDrawable(contextColor));
    ...
    public ActionBarSherlockCompat setIcon(int icon_back) {
        ActionBar actionBar = getActionBar();
        actionBar.setDisplayHomeAsUpEnabled(false);
    ...
    public ActionBarSherlockCompat setBackgroundDrawable(int color) {
    ...
    public ActionBarSherlockCompat setTitleActionBar(final CharSequence title) {
        return setTitleActionBar(title, 0);
    }

    public ActionBarSherlockCompat setTitleActionBar(final CharSequence title, int paddingLeft) {
        if (null == title)
            return this;

        if (this.actionBarTitleView == null) {
            this.actionBarTitleView = (TextView) mActivity.getLayoutInflater().inflate(R.layout.actionbar_title, actionBarContainer, false);
            actionBarTitleView.setPadding(paddingLeft, 0, 0, 0);
            this.actionBarCustomView.addView(actionBarTitleView,
                    new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT));
        }
        this.actionBarTitleView.setText(title);
...
/* todo: ???
      ...
      */
        if (aActionBar != null)
            return;
        aActionBar = new ActionBarImpl(mActivity, mFeatures, mDecor);
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        ...
        if (mActionMode != null && mListener instanceof OnActionModeStartedListener) {
            ((OnActionModeStartedListener)mListener).onActionModeStarted(mActionMode);
        }
        return mActionMode;
    }
    ...
    private void installDecor() {
        ...
        if (mDecor == null) {
// todo: ???            mDecor = (ViewGroup)mActivity.getWindow().getDecorView().findViewById(android.R.id.content);
            mDecor = mViewGroupParent;
        }
        if (mContentParent == null) {
...
*/
 ...
 /* todo: ???
        ...
        View in = mActivity.getLayoutInflater().inflate(R.layout.abs__screen_action_bar, null);
...
*/
    ...
    private class ActionModeCallbackWrapper implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (mListener instanceof OnActionModeFinishedListener) {
                ((OnActionModeFinishedListener)mListener).onActionModeFinished(mActionMode);
            }
            mActionMode = null;
        }
    }
