...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private ScrollQualifier scrollQualifier;
    ...
    public void setScrollQualifier(ScrollQualifier scrollQualifier) {
        this.scrollQualifier = scrollQualifier;
    }
    ...
    public void setColorSchemeWithColors(int color1, int color2, int color3, int color4) {
        ensureTarget();
        final Resources res = getResources();
        mProgressBar.setColorScheme(color1, color2, color3, color4);
    }
    ...
    public boolean canChildScrollUp() {
        if (scrollQualifier != null) {
            return scrollQualifier.canScroll();
    ...
    public interface ScrollQualifier {
        boolean canScroll();
    }
