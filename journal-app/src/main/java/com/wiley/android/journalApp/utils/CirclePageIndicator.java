...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultFillColor = res.getColor(R.color.blue_link_color);
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CirclePageIndicator, defStyle, 0);

        mCentered = typedArray.getBoolean(R.styleable.CirclePageIndicator_centered, defaultCentered);
        mOrientation = typedArray.getInt(R.styleable.CirclePageIndicator_android_orientation, defaultOrientation);
        ...
        final Drawable background = typedArray.getDrawable(R.styleable.CirclePageIndicator_android_background);
        if (background != null) {
