    ...
    require.relative=function(parent){
        ...
        Switchery.prototype.setPosition=function(clicked){
            ...
            if(clicked&&checked)
                ...
                checked=true;
            if(checked===true){
                this.jack.style.backgroundColor = "#27A1CA";
                this.jack.style.color = "#27A1CA";
                this.element.checked=true;
                if(window.getComputedStyle)
                    this.jack.style.left=parseInt(window.getComputedStyle(switcher).width)-parseInt(window.getComputedStyle(jack).width)+"px";
                else
                    this.jack.style.left=parseInt(switcher.currentStyle["width"])-parseInt(jack.currentStyle["width"])+"px";
                if(this.options.color)
                    this.colorize();
                this.setSpeed()
            }else{
                this.jack.style.backgroundColor = "#a1a1a1";
                this.jack.style.color = "#a1a1a1";
                this.jack.style.left=0;
                this.element.checked=false;
                this.switcher.style.boxShadow="inset 0 0 0 0 "+this.options.secondaryColor;
                this.switcher.style.borderColor=this.options.secondaryColor;
                this.switcher.style.backgroundColor=this.options.secondaryColor!==defaults.secondaryColor?this.options.secondaryColor:"#dfdfdf";
                this.setSpeed()
            }
        };
