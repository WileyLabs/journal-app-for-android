...
abstract class Request<R> {
    ...
    public static String getResponseDesc(int code) {
        String[] iab_msgs = ("0(OK)/"
                ...
                + "4 (Item unavailable)/"
                + "5 (Developer Error - maybe package name)/"
                + "6 (Error)/"
