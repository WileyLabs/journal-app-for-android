...
public final class AssetBasedIssueListFeedLoaderImpl extends AbstractAssetBasedFeedLoader implements IssueListFeedLoader {
    @Override
    public InputStream load() throws IOException {
        return doLoadInternal("offline_data/issuesList.xml");
    }
}
