...
public interface SpecialSectionService {
    SpecialSectionMO getSpecialSectionById(String id);

    void downloadSpecialSectionContent(String id);

    List<SpecialSectionMO> getSpecialSections();

    boolean hasSpecialSections();

    void create(SpecialSectionMO specialSection);

    void delete(SpecialSectionMO specialSection);

    long getOpenedSpecialSectionsCount();

    long count();

    void createOrUpdate(Collection<SpecialSectionMO> specialSections);
}
