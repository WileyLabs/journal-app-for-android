...
public class AssetBasedEarlyViewFeedLoaderImpl extends AbstractAssetBasedFeedLoader implements EarlyViewFeedLoader {
    @Override
    public InputStream load() throws IOException {
        return doLoadInternal("offline_data/earlyViewFeed.xml");
    }
}
